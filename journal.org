...
**** Savoirs-faire
     ...
     - Utiliser un générateurs d'analyseurs lexicals LL(1)
...
***** Lectures
      ...
      - Les combinateurs d'analyse syntaxique
      - L'analyse syntaxique du C, du shell script
      - L'analyse syntaxique pour les langages naturels (IBM/Watson)
***** Sujets de recherche
      - L'analyse syntaxique incrémentale (voir la thèse de doctorat de Tim Wagner)
